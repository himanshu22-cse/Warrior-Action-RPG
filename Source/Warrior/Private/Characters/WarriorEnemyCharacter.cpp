...
#include "DataAssets/Start-UpData/DataAsset_EnemyStartUpData.h"
...
{
	AutoPossessAI = EAutoPossessAI::PlacedInWorldOrSpawned; // Ensures We have Functional AI they are spawned in our world;
...
void AWarriorEnemyCharacter::InitEnemyStartUpData()
{
	...
	UAssetManager::GetStreamableManager().RequestAsyncLoad(
		...
		FStreamableDelegate::CreateLambda(
			...
			{
				if (UDataAsset_StartUpDataBase* LoadedData = CharacterStartUpData.Get()) //We can use the function "Get()" to retrieve the loaded object
				{
