...
struct Z_Construct_UScriptStruct_FWarriorHeroWeaponData_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WeaponAnimLayerToAnim_MetaData[] = {
		{ "Category", "WarriorHeroWeaponData" },
		{ "ModuleRelativePath", "Public/WarriorTypes/WarriorStructTypes.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FClassPropertyParams NewProp_WeaponAnimLayerToAnim;
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FWarriorHeroWeaponData_Statics::NewProp_WeaponAnimLayerToAnim = { "WeaponAnimLayerToAnim", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWarriorHeroWeaponData, WeaponAnimLayerToAnim), Z_Construct_UClass_UClass, Z_Construct_UClass_UWarriorHeroLinkedAnimLayer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeaponAnimLayerToAnim_MetaData), NewProp_WeaponAnimLayerToAnim_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FWarriorHeroWeaponData_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FWarriorHeroWeaponData_Statics::NewProp_WeaponAnimLayerToAnim,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Warrior_Source_Warrior_Public_WarriorTypes_WarriorStructTypes_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWarriorHeroWeaponData::StaticStruct, Z_Construct_UScriptStruct_FWarriorHeroWeaponData_Statics::NewStructOps, TEXT("WarriorHeroWeaponData"), &Z_Registration_Info_UScriptStruct_WarriorHeroWeaponData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWarriorHeroWeaponData), 190802252U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Warrior_Source_Warrior_Public_WarriorTypes_WarriorStructTypes_h_4045607157(TEXT("/Script/Warrior"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Warrior_Source_Warrior_Public_WarriorTypes_WarriorStructTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Warrior_Source_Warrior_Public_WarriorTypes_WarriorStructTypes_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
